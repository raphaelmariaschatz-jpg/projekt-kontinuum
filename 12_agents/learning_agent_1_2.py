...
class LearningAgent12:
    """Read-only proposal governance agent for controlled knowledge intake.

    Version 1.2 keeps all Learning Agent 1.0 classification behavior and adds a
    ...
    def generate_status_report(self, output_path: str | Path | None = None) -> Path:
        target = Path(output_path or self.project_root / "31_reports" / "learning_agent" / "learning_agent_1_2_status_report.md")
        ...
        target.write_text(
            "# Learning Agent 1.2 Status Report\n\n"
            f"Stand: {self._now()}\n\n"
            "## Status\n"
            "- Agent: learning_agent_1_2\n"
            "- Version: 1.2\n"
            ...
            "Learning Agent 1.2 fuehrt keine produktive Uebernahme aus.\n\n"
            "## Ergebnis\n"
            "Learning Agent 1.2 erweitert Version 1.1 um lesbare Kompatibilitaets- und Proposal-Lifecycle-Abschnitte im Statusreport. Die Queue-, History-, Provenance- und Confidence-Funktionen bleiben unveraendert erhalten. "
