...
class ContinuousLearningGovernance10:
    """Governance-only orchestrator for the Continuous Learning workflow."""

    name = "continuous_learning_governance_1_0"
    version = CLG_VERSION
    ...
    def __init__(self, project_root: str | Path | None = None):
        ...
        self.report_path = self.project_root / "31_reports" / "clg_1_0_status_report.md"
    ...
    def generate_status_report(self, output_path: str | Path | None = None) -> Path:
        ...
        target.write_text(
            "# Continuous Learning Governance 1.0 Status Report\n\n"
            f"Stand: {self._now()}\n\n"
            "## Governance Status\n"
...
ContinuousLearningGovernance = ContinuousLearningGovernance10
